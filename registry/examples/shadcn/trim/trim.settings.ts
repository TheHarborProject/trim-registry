...
// @trim-managed-schema {"version":1,"settings":[{"key":"starter","kind":"boolean","defaultValue":false},{"key":"text-size","kind":"segmented","options":["small","default","large"],"defaultValue":"default"}]}
//
